...
connection state of the bearer
...
Default (=selected) bearer: bearer used as default route, variable value
is the BEARERNAME.
...
The Monitoring Engine RAM usage and CPU performances was studied in the
